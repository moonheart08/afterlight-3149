ent-CrateServiceJanitorialSupplies = Janitorial supplies crate
    .desc = Fight back against dirt and grime with these unbranded Janitorial Essentials(tm)! Contains three buckets, caution signs, and cleaner grenades. Also has a single mop, broom, spray cleaner, rag, and trash bag.
